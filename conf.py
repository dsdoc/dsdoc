# -*- coding: utf-8 -*-
#
# dsdoc documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.intersphinx', 'sphinx.ext.viewcode', 'sphinx.ext.mathjax']
...
html_theme = 'dsdefault' # dsdefault basic default
...
html_title = description + '(' + project + ') v' + release
